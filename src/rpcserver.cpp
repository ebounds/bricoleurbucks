...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "Stop Bricoleur  server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Bricoleur server stopping";
}
...
{ //  name                      actor (function)         okSafeMode threadSafe reqWallet
  //  ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "createbricoleurour",          &createclamour,          false,     false,     true },
    ...
    { "getbricoleurour",             &getclamour,             true,      true,      false },
    { "listbricoleurours",           &listclamours,           true,      true,      false },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        string strWhatAmI = "To use bricoleurd";
